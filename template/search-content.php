<div class="row">
    <div class="col-12 search-sections-container">
        ...
        <input type="button" value="Add ingredient" class="button-secondary w-100" data-bs-toggle="modal" data-bs-target="#add-ingredient-modal" onclick="loadModal(ModalsType.SIMPLE_INGREDIENTS, simpleIngredientsCallback)">
